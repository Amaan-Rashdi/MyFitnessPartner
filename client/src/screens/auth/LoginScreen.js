...
import { loginApi, userLoginApi } from "../../redux/login/login.api";
import { useDispatch, useSelector } from "react-redux";
import { loginAction } from "../../redux/user/user.actions";
import { RadioButton } from "react-native-paper";

const LoginScreen = ({ navigation }) => {
  const [checked, setChecked] = React.useState("trainer");
  ...
  const loginHandle = async (userName, passWord) => {
    ...
    try {
      ...
      if (checked === "trainer") {
        ...
        console.log("====Trainer Login Data======");
        console.log(data);
        console.log("===========");
        ...
        <TouchableOpacity>
          ...
          >
            ...
            >
              <View>
                <Text>Trainer</Text>
                <RadioButton color="#9932cc" value="trainer" />
              </View>
              <View>
                <Text>Student</Text>
                <RadioButton color="#9932cc" value="student" />
              </View>
            </View>
          </RadioButton.Group>
        </TouchableOpacity>
